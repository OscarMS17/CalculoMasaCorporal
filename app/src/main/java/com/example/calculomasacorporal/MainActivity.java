package com.example.calculomasacorporal;
        ...
        public void myButtonListenerMethod(){
            ...
            button.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    final EditText heghtText = (EditText)
                            findViewById(R.id.HeightInput);
                    String heightStr = heghtText.getText().toString();
                    double height = Double.parseDouble(heightStr);
                    final EditText weigthText = (EditText)
                            findViewById(R.id.wheightinput);
                    String weightStr = weigthText.getText().toString();
                    double weight = Double.parseDouble(weightStr.toString());
                    double BMI = (weight) / (height * height);
                    final TextView BMIResult = (TextView)
